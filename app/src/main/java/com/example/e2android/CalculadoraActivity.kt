...
class CalculadoraActivity:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*recibimos kilos y estatura para calcular el IMC*/
        val kg = intent.getDoubleExtra("kilos", 0.0)
        val cm = intent.getDoubleExtra("estatura", 0.0)
        n1.setText(kg.toString())
        n2.setText(cm.toString())
        ...
        val btnImc: Button = findViewById(R.id.imcButton)
        btnImc.setOnClickListener {
            val numero1: Double = n1.text.toString().toDouble()
            val numero2: Double = n2.text.toString().toDouble()

            val resultado = model.calculaIMC(numero1, numero2)
            resultAdapter.addResult(resultado)
        }
    }
